...
class _FoodDetailScreenState extends State<FoodDetailScreen> {
  ...
  void _addFoodPressed(context) {
    final food = Food(
        imageFileName:
        widget.foodController.foodItemResponse.value.imageFilename,
        session: widget.session,
        date: widget.foodController.selectedDay.toString(),
        name: widget.foodController.foodItemResponse.value.foodName,
        calcium: widget.foodController.foodItemResponse.value.calcium,
        carbohydrate: widget.foodController.foodItemResponse.value.carbohydrate,
        copper: widget.foodController.foodItemResponse.value.copper,
        difficulty: widget.foodController.foodItemResponse.value.difficulty,
        duration: widget.foodController.foodItemResponse.value.duration,
        energy: widget.foodController.foodItemResponse.value.energy,
        fat: widget.foodController.foodItemResponse.value.fat,
        fiber: widget.foodController.foodItemResponse.value.fiber,
        foodId: widget.foodController.foodItemResponse.value.foodId,
        foodTypes: widget.foodController.foodItemResponse.value.foodTypes,
        ...
        itemFood: '',
        recommendationScore: widget.foodController.foodItemResponse.value
            .recommendationScore !=
            null
    ...
    Navigator.of(context).popUntil(ModalRoute.withName("/foodMealScreen"));
  }

  String _getFoodInformationString() {
    var energy = (widget.foodController.foodItemResponse.value.energy!)
        .toStringAsFixed(0);
    var duration = (widget.foodController.foodItemResponse.value.duration! / 60)
        .toStringAsFixed(0);
    var serving = (widget.foodController.foodItemResponse.value.serving!)
        .toStringAsFixed(0);
    return "${energy} cal | ${duration} menit | ${serving} porsi";
  }

  bool _isImageExist() {
    return widget.foodController.foodItemResponse.value.imageFilename == '';
  }
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          ...
          IconButton(
            icon: Icon(Icons.check, size: 35.sp, color: Colors.white),
            onPressed: () {
              _addFoodPressed(context);
            },
          ) : Container(),
        ],
        title: Text(
      ...
      children: [
        Container(
          decoration: BoxDecoration(
            ...
            border: Border.all(color: HexColor.fromHex("#73C639")),
            boxShadow: [
              BoxShadow(
            ...
            children: [
              SizedBox(
                ...
                child: _isImageExist()
                  ...
                  child: Image.network(
                    widget.foodController.foodItemResponse.value
                        .imageFilename!,
                    fit: BoxFit.cover,
                  ),
                ),
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        Text(
                          _getFoodInformationString(),
                          style: GoogleFonts.inter(
                              color:
                              HexColor.fromHex("#3F4A62").withOpacity(0.65),
                              fontWeight: FontWeight.w500,
                              fontSize: 14.sp),
                        ),
                      ],
                      ...
                      children: [
                        ...
                        CustomPaint(
                          ...
                          foregroundPainter: CircleProgressBarPainter(
                            foregroundColor: widget.color.secondaryColor,
                            backgroundColor: widget.color.secondaryTextColor
                                .withOpacity(0.3),
                            percentage: (widget.foodController
                        ...
                        CustomPaint(
                          ...
                          foregroundPainter: CircleProgressBarPainter(
                            ...
                            backgroundColor: widget.color.secondaryTextColor
                                .withOpacity(0.3),
                            percentage: (widget.foodController
                                .foodItemResponse.value.protein! /
                                widget.foodController.foodItemResponse
                                    .value.serving!) /
                                (widget.foodController.necessity.value
        ...
        const SizedBox(height: 10),
        _buildBahanContainer(),
        const SizedBox(height: 10),
        _buildLangkahContainer(),
      ],
    );
  }

  Container _buildLangkahContainer() {
    return Container(
        decoration: BoxDecoration(
          color: widget.color.primaryColor,
          borderRadius: BorderRadius.circular(20),
        ...
        child: Padding(
          ...
          Column(
            ...
            children: [
              ...
              Column(
                children: widget.foodController.foodItemResponse
                    .value.foodInstructionInfo!
                    .map(
                      (e) =>
                      Row(
                        crossAxisAlignment:
  ...
  Container _buildBahanContainer() {
    return Container(
        decoration: BoxDecoration(
          color: widget.color.primaryColor,
          borderRadius: BorderRadius.circular(20),
  ...
  SafeArea _buildOldContent(BuildContext context) {
    return SafeArea(
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Container(
                          margin: EdgeInsets.only(right: 5.w), child: SizedBox()
                        //  NeumorphicButton(
                        //   onPressed: () {},
                        //   style: NeumorphicStyle(
                        //     depth: 0,
              ...
              Neumorphic(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                        children: widget
                            .foodController.foodItemResponse.value.foodTypes!
                            .map((e) =>
                            Container(
                              decoration: BoxDecoration(
                                  borderRadius: BorderRadius.circular(20),
                    ...
                    Row(children: [
                      ...
                      Text(
                        ...
                        style: GoogleFonts.poppins(
                          textStyle: TextStyle(
                              color: widget.color.tersierColor.withOpacity(0.6),
                              fontSize: 14.sp,
                              fontWeight: FontWeight.w600),
                        ),
                      ),
                ...
                children: [
                  ...
                  widget.foodController.listOtherFood.isNotEmpty
                    ...
                    child: ListView.builder(
                      ...
                      itemCount: widget
                          .foodController.listOtherFood.length,
                      itemBuilder: (context, index) {
                        return Container(
                          margin: EdgeInsets.all(10.sp),
                          child: OtherFoodRecommendationTile(
                            isFromFoodMeal: widget.isFromFoodMeal,
        ...
        Column(
          ...
          children: [
            ...
            !widget.isFromFoodMeal
              ...
              onPressed: () {
                final food = Food(
                    imageFileName: widget.foodController.foodItemResponse
                        .value.imageFilename,
                    session: widget.session,
                    date: widget.foodController.selectedDay.toString(),
                    name: widget
                        .foodController.foodItemResponse.value.foodName,
                    calcium: widget
                        .foodController.foodItemResponse.value.calcium,
                    carbohydrate: widget.foodController.foodItemResponse
                        .value.carbohydrate,
                    copper: widget
                        .foodController.foodItemResponse.value.copper,
                    difficulty: widget
                        .foodController.foodItemResponse.value.difficulty,
                    duration: widget
                        .foodController.foodItemResponse.value.duration,
                    energy: widget
                    ...
                    foodTypes: widget
                        .foodController.foodItemResponse.value.foodTypes,
                    iron:
                    widget.foodController.foodItemResponse.value.iron,
                    phosphor: widget
                        .foodController.foodItemResponse.value.phosphor,
                    potassium: widget
                        .foodController.foodItemResponse.value.potassium,
                    protein: widget
                        .foodController.foodItemResponse.value.protein,
                    retinol: widget
                        .foodController.foodItemResponse.value.retinol,
                    serving: widget
                        .foodController.foodItemResponse.value.serving,
                    sodium: widget
                        .foodController.foodItemResponse.value.sodium,
                    tags:
                    widget.foodController.foodItemResponse.value.tags,
                    vitaminB1: widget
                        .foodController.foodItemResponse.value.vitaminB1,
                    vitaminB2: widget
                        .foodController.foodItemResponse.value.vitaminB2,
                    vitaminB3: widget
                        .foodController.foodItemResponse.value.vitaminB3,
                    vitaminC: widget
                        .foodController.foodItemResponse.value.vitaminC,
                    water: widget.foodController.foodItemResponse.value.water,
                    zinc: widget.foodController.foodItemResponse.value.zinc,
                    // instruction: foodController
                    //     .listFood[index]
                    ...
                    // itemFood: 'widget.foodController.foodItemResponse.toJson()',
                    itemFood: '',
                    recommendationScore: widget.foodController.foodItemResponse
                        .value.recommendationScore != null ? widget
                        .foodController.foodItemResponse.value
                        .recommendationScore!.toStringAsFixed(2) : '');
                widget.foodController.foodStore.box<Food>().put(food);
