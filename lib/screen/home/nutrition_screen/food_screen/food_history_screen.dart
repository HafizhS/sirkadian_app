                      ...
                      ? Neumorphic(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Column(
                                  children:
                                      foodController.listFoodHistory[index]
                                                                  ...
                                                                  bottomSheetNecesityChild(
                                                                      ...
                                                                      element.totalEnergy! /
                                                                          (element.foodTime == 'breakfast'
                                                                              ...
                                                                              : element.foodTime == 'lunch'
                                                                                  ? foodController.necessity.value.energy!.lunch!
                                                                                  : foodController.necessity.value.energy!.dinner!)),
                                                                  bottomSheetNecesityChild(
                                                                      'Karbohidrat',
                                                                      element.totalCarbohydrate! /
                                                                          (element.foodTime == 'breakfast'
                                                                              ? foodController.necessity.value.macro!.breakfast!.carbohydrate!
                                                                              : element.foodTime == 'lunch'
                                                                                  ? foodController.necessity.value.macro!.lunch!.carbohydrate!
                                                                                  : foodController.necessity.value.macro!.dinner!.carbohydrate!)),
                                                                  bottomSheetNecesityChild(
                                                                      'Protein',
                                                                      element.totalProtein! /
                                                                          (element.foodTime == 'breakfast'
                                                                              ? foodController.necessity.value.macro!.breakfast!.protein!
                                                                              : element.foodTime == 'lunch'
                                                            ...
                                                            child: Column(
                                                              ...
                                                              children: [
                                                                Container(
                                                                    ...
                                                                    width:
                                                                        130.w,
                                                                    child: element.foods![idx].food!.imageFilename ==
                                                                            ''
                                                                        ? Icon(Icons
                                                                        ...
                                                                        : ClipRRect(
                                                                            ...
                                                                            child:
                                                                                Image.network(
                                                                              element.foods![idx].food!.imageFilename!,
                                                                              fit: BoxFit.cover,
                                                                            ),
                                                                          )),
                                                                Text(
