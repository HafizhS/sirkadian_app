                  ...
                  children: [
                    CustomPaint(
                      child: Container(
                        ...
                        child: Text(
                          '${((foodController.water / foodController.necessity.water!) * 100).round().toString()}%',
                          style: GoogleFonts.poppins(
                            textStyle: TextStyle(
                      ...
                      foregroundPainter: CircleProgressBarPainter(
                        ...
                        percentage: foodController.water /
                            foodController.necessity.water!,
                        sizeContainer: Size(size.width * 0.4, size.width * 0.4),
                      ),
                    ),
                    RichText(
                      text: TextSpan(
                        ...
                        children: <TextSpan>[
                          TextSpan(
                              text:
                                  ' / ${foodController.necessity.water!.toStringAsFixed(0)}',
                              style: GoogleFonts.poppins(
                                  textStyle: TextStyle(
                                      color: color.primaryTextColor,
                                      fontSize: 16,
