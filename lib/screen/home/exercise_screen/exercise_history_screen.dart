...
class _ExerciseHistoryScreenState extends State<ExerciseHistoryScreen> {
  ...
  List<DataExerciseHistoryGetResponse> _searchResult = [];
  ...
  Widget build(BuildContext context) {
    print(exerciseController.listExerciseHistory);
    return Scaffold(
      body: Obx(
        () => exerciseController.isLoadingExerciseHistory.isTrue
            ? Center(
            ...
            : SafeArea(
                          ...
                          onPressed: () {
                            if (_searchResult.isNotEmpty) {
                              ...
                              DatePicker.showDatePicker(context,
                                ...
                                // exerciseController.listExerciseHistory
                                //     .forEach((element) {
                ...
                _searchResult.isNotEmpty
                    ...
                    : historyListWidget(
                        sourceList: exerciseController.listExerciseHistory)
              ])),
      ),
    );
  }

  Widget historyListWidget({List<DataExerciseHistoryGetResponse>? sourceList}) {
    return Expanded(
                  ...
                  ? Neumorphic(
                      ...
                      child: Column(
                        ...
                        children: [
                          Row(
                            ...
                            children: [
                              Container(
                                ...
                                child: Text(
                                  sourceList[index].name.toString(),
                                  style: GoogleFonts.poppins(
                                    textStyle: TextStyle(
                                        color: color.secondaryTextColor,
                                        fontSize: 18.sp,
                          ...
                          ///
                          //   Column(
                          //       children: exerciseController
                          //           .listExerciseHistory[index].historyList!.reversed
                          //           .map((element) => Column(
                          //                 crossAxisAlignment:
