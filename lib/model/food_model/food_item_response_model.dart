class FoodItemResponse {
  ...
  String? message;
  Null errorCode;
  DataFoodItemResponse? data;

  FoodItemResponse({this.statusCode, this.message, this.errorCode, this.data});
  ...
  FoodItemResponse.fromJson(Map<String, dynamic> json) {
    ...
    data = json['data'] != null
        ? new DataFoodItemResponse.fromJson(json['data'])
        : null;
  }
...
class DataFoodItemResponse {
  ...
  DataFoodItemResponse.fromJson(Map<String, dynamic> json) {
