class ExerciseItemResponse {
  ...
  String? message;
  Null errorCode;
  DataExerciseItemResponse? data;

  ExerciseItemResponse(
      {this.statusCode, this.message, this.errorCode, this.data});

  ExerciseItemResponse.fromJson(Map<String, dynamic> json) {
    statusCode = json['statusCode'];
    message = json['message'];
    errorCode = json['errorCode'];
    data = json['data'] != null
        ? new DataExerciseItemResponse.fromJson(json['data'])
        : null;
  }
...
class DataExerciseItemResponse {
  String? name;
  String? desc;
  double? mets;
  String? difficulty;
  ...
  DataExerciseItemResponse.fromJson(Map<String, dynamic> json) {
    name = json['name'];
    desc = json['desc'];
    mets = json['mets'];
